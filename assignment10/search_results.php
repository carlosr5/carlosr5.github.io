...
$form_sql = "SELECT dvd_titles.title AS 'dvd_title', dvd_titles.release_date AS 'release_date', genres.genre AS 'genre', ratings.rating AS 'rating', dvd_titles.dvd_title_id AS 'dvd_id'
FROM dvd_titles
JOIN genres
            ...
            <div class="col-12">
                <table class="table table-hover table-responsive mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="btn btn-outline-danger delete-btn">
                                <a onclick="return confirm('Are you sure you want to delete this DVD?')" href="delete.php?dvd_id=
                                <?php echo trim($form_item['dvd_id']); ?>
                                &dvd_title=
                                <?php echo $form_item['dvd_title']; ?>
                                ">
                                    Delete
                                </a>
                            </td>
                            <td>
                                ...
                                ?>
                                ">
                                    <?php echo trim($form_item["dvd_title"]); ?>
                                </a>
                            </td>
                            <td><?php echo $form_item["release_date"]; ?></td>
